...
namespace Passive.API.CQRS.Handlers.Bases.CommandBases
{
    ...
    {
        public CreateCommandHandlerBase(ILogger<CreateCommandHandlerBase<TModel, TModelKey, TRequest, TResponse>> logger, IBusinessLogicBase<TModel, TModelKey, DbContext> businessLogicBase) : base(logger, businessLogicBase)
        {
        }
    }
}
